...
import static example.Gem.h;
import static example.Gem.orgX;
import static example.Gem.orgY;
import static example.Gem.w;
...
public class Board {
    ...
    public static void showAll(Gem[] table){
        for(int i=0; i<64; i++){
            table[i].pic=table[i].getPicFromId(true);
        }
    }
}
