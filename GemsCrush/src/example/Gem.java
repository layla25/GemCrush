...
public class Gem {
    ...
    private Image focus;
    private Image blank;
    //private Image bomber_pic;
    private Image frozen_pic;
    private Image chocolate_pic;
    private Sound select=new Sound("/assets/select.wav");
    
    private Image bear=new ImageIcon(this.getClass().getResource("/assets/bear.png")).getImage();
    private Image dolphin=new ImageIcon(this.getClass().getResource("/assets/dolphin.png")).getImage();
    private Image bird=new ImageIcon(this.getClass().getResource("/assets/bird.png")).getImage();
    private Image snail=new ImageIcon(this.getClass().getResource("/assets/snail.png")).getImage();
    private Image dog=new ImageIcon(this.getClass().getResource("/assets/dog.png")).getImage();
    private Image butterfly=new ImageIcon(this.getClass().getResource("/assets/butterfly.png")).getImage();
    private Image frog=new ImageIcon(this.getClass().getResource("/assets/frog.png")).getImage();
    ...
    Gem(String file, int x, int y,int picId) {
        ...
        //this.bomber_pic = new ImageIcon(this.getClass().getResource("/assets/bomb.png")).getImage();
    ...
    public boolean switchGem(Gem other) {
        if (this.canSwitch(other)&&this.frozen==false&&other.frozen==false) 
        {                    
    ...
    public void switchAnimation(Gem other, int iteration) {    	
    ...
    public boolean canSwitch(Gem other) {
        if(this.posX==other.posX&&this.posY==other.posY)
            return false;
        else if (this.posX == other.posX && abs(this.posY - other.posY) == 1) 
            return true;         
        else if (this.posY == other.posY && abs(this.posX - other.posX) == 1) 
            return true;
        else     
            return false;
    }
